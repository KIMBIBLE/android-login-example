...
import com.bbkimAssign.fragments.ChangePasswordDialog;
import com.bbkimAssign.model.Response;
import com.bbkimAssign.model.User;
import com.bbkimAssign.network.NetworkUtil;
import com.bbkimAssign.utils.Constants;
...
public class ProfileActivity extends AppCompatActivity implements ChangePasswordDialog.Listener {
    ...
    private void initViews() {
        ...
        mBtVideo = (Button) findViewById(R.id.btn_video);
        mProgressbar = (ProgressBar) findViewById(R.id.progress);

        mBtChangePassword.setOnClickListener(view -> showDialog());
        mBtLogout.setOnClickListener(view -> logout());
        mBtVideo.setOnClickListener(view -> showVideoPage());
    }
